...
const Blog = () => {
    ...
    const fetchBlogData = async () => {
       try{
        ...
        data.success ? setData(data.blogData) : toast.error(data.message)
       } catch(error){
    ...
    return data ? (
        <div className='relative'>
            <img
                ...
                alt=""
                className='absolute -top-[200px] -z-10 opacity-50 w-full'
            />
            ...
            <div className='mx-5 max-w-5xl md:mx-auto my-10 mt-6'>
                <img src={data.image} alt={data.title} className='rounded-3xl mb-5 w-full object-cover' />
